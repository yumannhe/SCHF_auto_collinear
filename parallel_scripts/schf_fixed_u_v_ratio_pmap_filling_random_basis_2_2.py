...
filling_arr = -jnp.linspace(-1, 0, num_filling_points, endpoint=False)[::-1]*4
num_u_points = 16
...
np.savez_compressed(
    os.path.join(project_root, "u_v1_v2_t_4_em4_mesh_30_2_2_pmap_over_filling_seed_121.npz"),
