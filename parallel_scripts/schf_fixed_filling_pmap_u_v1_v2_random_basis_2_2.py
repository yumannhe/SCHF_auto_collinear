...
# similarly, divided by the factor of 4 to match the correct filling
input_d_tot = input_d_tot * filling/10.0/4.0
...
np.savez_compressed(
    os.path.join(project_root, "schf_filling_1_t_4_em4_random_basis_mesh_30_2_2.npz"),
    u=np.asarray(u_arr),
    v=np.asarray(v_arr),
    d=host_res["d"],
    bond=host_res["bond"],
