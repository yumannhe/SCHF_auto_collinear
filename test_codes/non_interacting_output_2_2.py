...
basis_frac_o = np.array([[1/2, 0], [1/2, 1/2], [0, 1/2]])/2
basis_frac = np.concatenate((basis_frac_o, basis_frac_o + np.array([0, 1/2]), basis_frac_o + np.array([1/2, 0]), basis_frac_o + np.array([1/2, 1/2])), axis=0)
